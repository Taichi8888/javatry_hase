...
public class UndeadBarkingProcess extends BarkingProcess{
    ...
    //                                                                         Constructor
    //                                                                         ===========
    // TODO done hase ここは Undead と言い切ってますから、引数の型も Undead で良いかと by jflute (2025/07/15)
...
//        // TODO done hase [いいね]ダウンキャストに対する念のための処理をしっかり丁寧にしているの素晴らしい by jflute (2025/07/15)
//        // TODO done hase 修行++: 一方で、このダウンキャストうーむーな感じですよね...ここまで階層化しておいてダウンキャストが発生しちゃうのも... by jflute (2025/07/15)
...
//            // TODO done hase キャストできなかった creature をメッセージに残しておきましょう by jflute (2025/07/15)
//            // ネストの e で情報出てくるかもしれないけど、ないこともあるから自分のメッセージにデバッグしやすい情報を載せましょう。
//            // TODO done hase [読み物課題] 例外メッセージ、敬語で満足でもロスロスパターン by jflute (2025/07/15)
