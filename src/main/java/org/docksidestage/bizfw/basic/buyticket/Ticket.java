...
//        this.onlyNightAvailable = ticketType.isOnlyNightAvailable(); // 夜間限定フラグ
    ...
    //                                                                             In Park
    //                                                                             =======
    // done hase [いいね] throws素晴らしい by jflute (2025/07/15)
    /**
...
//        // done hase 修行++: この判定をTicketType側に持っていってもいいかも by jflute (2025/08/19)
...
//    }
    ...
    // done hase [へんじ] おお、これは悩ましいですね。スッキリさを優先するのであればTicketTypeさえgetできれば... by jflute (2025/07/09)
    ...
    // 承知しました！自信を持って理由を話せるようなコードを書くことが大事だと理解しました。bu hase (2025/07/09)
